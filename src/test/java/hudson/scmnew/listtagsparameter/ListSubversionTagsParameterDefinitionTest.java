...
import hudson.scmnew.AbstractSubversionTest;
...
public class ListSubversionTagsParameterDefinitionTest {
    ...
    private void assertSniff(String user, String sniffed, boolean ok) throws Exception {
        ...
        try {
            ...
            String checkUrl = "job/p/descriptorByName/hudson.listtagsparameter.scmnew.ListSubversionTagsParameterDefinition/checkCredentialsId?value=svncreds&tagsDir=" + URLEncoder.encode(sniffURL.toString(), "UTF-8");
